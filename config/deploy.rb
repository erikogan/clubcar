...
# suggestions from the skate punk book
...
role :web, "eogan.usr.cloudshield.com"
role :app, "eogan.usr.cloudshield.com"
role :db, "eogan.usr.cloudshield.com", :primary => true
