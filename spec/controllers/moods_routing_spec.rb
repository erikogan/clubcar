...
describe MoodsController do
  describe "route generation" do
    ...
    it "should map #update" do
      route_for(:controller => "moods", :user_id => "1", :action => "update", :id => 1).should == "/users/1/moods/1"
    end
  
    it "should map #destroy" do
      route_for(:controller => "moods", :user_id => "1", :action => "destroy", :id => 1).should == "/users/1/moods/1"
    end
  end
