...
describe RestaurantsController do
  ...
  describe "responding to GET index" do
    ...
    it "should expose all restaurants as @restaurants" do
      Restaurant.should_receive(:find).with(:all, :order => :name).and_return([mock_restaurant])
      get :index
    ...
    describe "with mime type of xml" do
      ...
      it "should render all restaurants as xml" do
        ...
        Restaurant.should_receive(:find).with(:all, :order => :name).and_return(restaurants = mock("Array of Restaurants"))
  ...
  describe "responding to GET show" do
    ...
    it "should expose the requested restaurant as @restaurant" do
      Restaurant.should_receive(:find).with("37", :include => [:tags]).and_return(mock_restaurant)
      get :show, :id => "37"
